...
- (void)viewDidLoad
{
    ...
    self.wrapper = [[KeychainItemWrapper alloc] initWithIdentifier:@"keychain demo" accessGroup:@"V3KLKNYYW6.qyyl.game.GWAPP"];
...
//        [self.wrapper setObject:self.textField.text forKey:@"99"];
...
//    NSString *account = [self.wrapper objectForKey:@"99"];
